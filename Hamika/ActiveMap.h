...
namespace UI::Game
{
	class ActiveMap:public Panel, public ObjectBase::Interface
	{
		private: std::shared_ptr<Res::Account> _account;
		...
		private: KIR5::Shared<Panel> drawnerPanel;
		...
		public: void playGame(const std::shared_ptr<Res::BluePrint> &bluePrint_, const std::shared_ptr<Res::Account> &account_);
		private: void signVictory();
		private: void signPlay();
